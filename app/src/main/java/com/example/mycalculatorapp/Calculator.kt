...
import com.example.mycalculatorapp.ui.theme.LightGray
import com.example.mycalculatorapp.ui.theme.Orange
import com.example.mycalculatorapp.ui.theme.LightGray
import com.example.mycalculatorapp.ui.theme.Orange
...
@Composable
fun DefaultCalc(){
    Calculator(state = CalculatorState(), onAction = ({ CalculatorAction -> Unit })
    )
}